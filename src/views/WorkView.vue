<template>
  <div class="mx-auto md:w-1/3">
    ...
    <ul class="">
      <li
        class="my-24 "
        v-for="project in projectsByDate"
        :key="project.name"
      >
...
export default defineComponent({
  ...
  data() {
    return {
      projects: [
      {
          ...
          date: "2021-",
          description: "I created a scholarship application and evaluation portal for a regional statistics society. The committee required a FERPA compliant site that would allow for the secure handling of student transcript information. The solution was comprised of a MERN-stack app built on AWS infrastructure.",
          href: "",
        },
        {
          name: "Charles VR",
  ...
  computed: {
    projectsByDate() {
      return this.projects.sort( (a,b) => {return a.date > b.date ? -1 : 1}) 
    }
  },
});
</script>
